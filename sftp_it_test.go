...
func TestSFTPClient_ConnectIT(t *testing.T) {
	client := Client{}
...
func TestSFTPClient_UploadFileIT(t *testing.T) {
	client := new(Client)
	sftpClient := client.NewClient(user, password, host, port)
	require.NotNil(t, sftpClient)
	defer sftpClient.Close()
...
func TestSFTPClient_DownloadFileIT(t *testing.T) {
	client := new(Client)
	sftpClient := client.NewClient(user, password, host, port)
	require.NotNil(t, sftpClient)
	defer sftpClient.Close()
	...
	createRemoteTestFile(sftpClient.(*SFTPClient), remotePath, t)
